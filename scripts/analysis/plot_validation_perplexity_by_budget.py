...
OUT_PNG = OUT_DIR / "validation_perplexity_by_budget.png"

METRIC_NAME = "validation_perplexity"
...
def load_from_descriptives() -> dict[tuple[str, str], tuple[float, float]]:
    ...
    raise ValueError("No usable validation_perplexity rows found in descriptives artifact.")
...
def load_from_summary_flat() -> dict[tuple[str, str], tuple[float, float]]:
    ...
    raise ValueError("No usable validation_perplexity values found in summary-flat artifact.")
