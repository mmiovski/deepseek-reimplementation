...
def build_row(summary: dict[str, Any], *, source_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "requested_train_tokens": summary.get("requested_train_tokens"),
        "train_tokens": summary.get("train_tokens"),
        "train_token_overshoot": summary.get("train_token_overshoot"),
        "train_token_overshoot_ratio": summary.get("train_token_overshoot_ratio"),
