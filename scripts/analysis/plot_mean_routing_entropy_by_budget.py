...
OUT_PNG = OUT_DIR / "mean_routing_entropy_by_budget.png"

METRIC_NAME = "mean_routing_entropy"
...
def load_from_descriptives() -> dict[tuple[str, str], tuple[float, float]]:
    ...
    raise ValueError("No usable mean_routing_entropy rows found in descriptives artifact.")
...
def load_from_summary_flat() -> dict[tuple[str, str], tuple[float, float]]:
    ...
    raise ValueError("No usable mean_routing_entropy values found in summary-flat artifact.")
